...
public class signin_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuth.getCurrentUser() != null) {
            startActivity(new Intent(signin_activity.this, Home_page.class));
            finish();
        }
                        ...
                        .addOnCompleteListener(signin_activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(signin_activity.this, Home_page.class);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Log.d(TAG, "signInWithEmail:Fail");
                                    Toast.makeText(signin_activity.this, getString(R.string.fail), Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
